...
<title>注册</title>
<link href="<%=request.getContextPath()%>/static/register/css/bootstrap.min.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/static/register/css/gloab.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/static/register/css/index.css" rel="stylesheet">
<script src="<%=request.getContextPath()%>/static/register/js/jquery-1.11.1.min.js"></script>
<script src="<%=request.getContextPath()%>/static/register/js/register.js"></script>
</head>
<body class="bgf4">
